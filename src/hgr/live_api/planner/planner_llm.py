...
class LLMPlanner:
    ...
    def _tool_catalog(self) -> str:
        ...
        lines.extend([
            ...
            "summary, forecast[]}. `summary` is a pre-rendered, casual, "
            "Jarvis-style sentence using the user's REAL location and "
            "the REAL forecast data for the days they asked for — emit "
            "{step:N.summary} VERBATIM as the final reply (no "
            "rephrasing, no shortening, no rewriting the location). "
            "Rephrasing causes wrong locations and robotic templates. "
            "When chaining weather INTO an email/message body, also "
            "use {step:N.summary}.",

...
_SYSTEM_PROMPT = (
    ...
    "in future turns.\n\n"
    "OUTPUT FORMAT — must be a single JSON object with one key, 'facts', "
    "whose value is an array (possibly empty). Each array item is:\n"
    ...
    "5. Multi-fact statements split into multiple entries — extract "
    "EVERY distinct fact (e.g. 'my prof is Dr. Smith and his office is "
    "Owen 102' is TWO facts: a person AND a place).\n"
    "6. If nothing factual was revealed, output {\"facts\": []}.\n\n"
    "EXAMPLES (each shows the exact response shape you should produce):\n\n"
    "User said: 'my office is in Kearney 204'\n"
    "Response: {\"facts\": [{\"kind\":\"place\",\"key\":\"office\","
    "\"value\":\"Kearney 204\",\"confidence\":0.95}]}\n\n"
    "User said: 'Vesko is my brother'\n"
    "Response: {\"facts\": [{\"kind\":\"relation\",\"key\":\"brother\","
    "\"value\":\"Vesko\",\"confidence\":0.95},"
    "{\"kind\":\"person\",\"key\":\"vesko\",\"value\":\"my brother\","
    "\"confidence\":0.85}]}\n\n"
    "User said: 'my professor's name is Dr. Smith and his office is Owen 102'\n"
    "Response: {\"facts\": [{\"kind\":\"person\",\"key\":\"professor\","
    "\"value\":\"Dr. Smith\",\"confidence\":0.95},"
    "{\"kind\":\"place\",\"key\":\"professor-office\","
    "\"value\":\"Owen 102\",\"confidence\":0.95}]}\n\n"
    "User said: 'I prefer to be called Konstantin, not Kosta'\n"
    "Response: {\"facts\": [{\"kind\":\"preference\",\"key\":\"preferred_name\","
...
def extract_facts_from_conversation(
    ...
    # Notes on params for newer GPT-5-era reasoning models (gpt-5-mini,
    # o-series): they (1) ONLY accept default temperature (1.0), (2) reject
    # max_tokens — use max_completion_tokens, and (3) consume INVISIBLE
    # reasoning tokens that count toward max_completion_tokens. With a
    # tight cap the model can use everything on thinking and leave 0 for
    # output. 4000 leaves plenty of room for both. response_format=
    # json_object + strict system prompt keeps output structured.
    body = {
        "model": chosen_model,
        "messages": [
